...
Location: benchmark/nautilus_trader/native_recorder/__main__.py
...
Usage:
    python -m benchmark.nautilus_trader.native_recorder --config path/to/config.yaml
    python -m benchmark.nautilus_trader.native_recorder --instruments SOLUSDT-SPOT.BYBIT --duration 300
...
Examples:
  ...
  python -m benchmark.nautilus_trader.native_recorder --config config_templates/bybit_spot_recording.yaml

  # Quick recording (default 5 minutes)
  python -m benchmark.nautilus_trader.native_recorder --instruments SOLUSDT-SPOT.BYBIT

  # Custom duration and multiple symbols
  python -m benchmark.nautilus_trader.native_recorder \\
